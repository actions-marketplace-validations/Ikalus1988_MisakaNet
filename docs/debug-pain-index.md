...
|------|---------------|--------|
| DCO sign-off | `DCO check failed` / `Missing Signed-off-by` | [dco-auto-fix-workflow](lessons/dco-auto-fix-workflow/) |
| GitHub token | `GH013: Secret scanning` / `401 Unauthorized` | [github-api](lessons/github-api-pr-issue-management/) |
| pip timeout | `Read timed out` / `HTTPSConnectionPool` | [pip-timeout](lessons/pip-install-timeout-ssl/) |
...
| Windows Unicode | `UnicodeEncodeError: 'charmap'` | [windows-encoding](lessons/python-gbk-encoding-error/) |
| WSL permission | `Permission denied: /mnt/c/...` | [wsl-permission](lessons/permission-denied-fix/) |
